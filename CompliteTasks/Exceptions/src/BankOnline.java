...
public class BankOnline {
    public static List<String> blocked = Arrays.asList("1111111111111111", "2222222222222222", "3333333333333333");
    ...
    public void send(String cardNumber, Double money) throws BankOnlineException {
        ...
        if (cardNumber.length() != 16 || isOnlyDigits == false) { throw new InvalidCardNumber(); }
